...
<select id="name" class="howmanyitems" name="name" onchange="howmanyitems(this.value,'man')" >
  ...
  <div  class="modal fade" id="myModal" role="dialog">
    <div style="height:300px "  class="modal-dialog">
      ...
      <div  class="modal-content">
        ...
        <form action="man.php" method="GET" autocomplete="off" >
        <div  class="containerfilter">
            <?php  
                        $databrand=mysqli_query($baglan,"select distinct  Brand  from glass where Gender='Erkek'");
                        $datashape=mysqli_query($baglan,"select Frameshape, Frameshapeicon  from glass where Gender='Erkek' group by Frameshape");
                        $dataglass=mysqli_query($baglan,"select distinct  Glassmaterial  from glass where Gender='Erkek'");
                        $datamaterial=mysqli_query($baglan,"select distinct  Framematerial  from glass  where Gender='Erkek'");
                        $datamodelnumber=mysqli_query($baglan,"select distinct  ModelNumber  from glass  where Gender='Erkek'");
                        $dataprice=mysqli_query($baglan,"select distinct  Price  from glass where Gender='Erkek'");
                        $dataframecolor=mysqli_query($baglan,"select distinct  Framecolor , Colorcode  from glass  where Gender='Erkek'");
                        $dataproductdiv=mysqli_query($baglan,"select distinct  ProductDiv	  from glass where Gender='Erkek'");
             ?>
...
<?php  
$sorgu="select * from glass where Gender IN ('Erkek') ";
...
//echo '<div style="background-color:blue;" class="container">';
    for($page=1;$page<=$numberofpages;$page++){
        echo '<a  href="man.php?page='.$page.'">'.$page.'</a>';
    }
 // echo '</div>';
  }
  ?>
...
<?php
 ...
 margin: auto;  width: 50%;" src="Glasspictures/glassnotfount.jpg" alt="hata">
